...
class KeyboardLoaderUtil private constructor() {
    ...
    private fun loadBaseSkb(skbValue: Int): SoftKeyboard {
        ...
        when(skbValue){
            InputModeSwitcherManager.MASK_SKB_LAYOUT_QWERTY_PINYIN -> {
            ...
            InputModeSwitcherManager.MASK_SKB_LAYOUT_T9_PINYIN -> {
            ...
            InputModeSwitcherManager.MASK_SKB_LAYOUT_HANDWRITING -> {// 3000 手写键盘
                ...
                var handwritingKey = createHandwritingKey(keys[0][0])
            ...
            InputModeSwitcherManager.MASK_SKB_LAYOUT_STROKE -> {
            ...
            InputModeSwitcherManager.MASK_SKB_LAYOUT_TEXTEDIT -> {
                var keyBeans: MutableList<SoftKey> = LinkedList()
    ...
    companion object {
        ...
        private val mSoftKeyboardMap = HashMap<Int, SoftKeyboard?>()
        @JvmStatic
