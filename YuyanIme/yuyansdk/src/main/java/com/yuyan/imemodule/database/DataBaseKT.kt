...
abstract class DataBaseKT : RoomDatabase() {
    ...
    companion object {
        ...
        private val MIGRATION_4_5 = object : Migration(4, 5) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("INSERT INTO skbfun (name, isKeep, position) VALUES ('VoiceInput', 0, 16)")
            }
        }
        ...
        private fun initPhrasesDb() {
            ...
            if(instance.skbFunDao().getAllMenu().isEmpty()) {
                val skbFuns = listOf(
                    ...
                    SkbFun(name = SkbMenuMode.VoiceInput.name, isKeep = 0, position = 16),
                )
