...
object RimeEngine {
    ...
    private var pinyins: Array<String> = emptyArray()
    var showCandidates: List<CandidateListItem> = emptyList()
    var showComposition: String = ""
    var preCommitText: String = ""
    private var customPhraseSize: Int = 0
    fun init() {
