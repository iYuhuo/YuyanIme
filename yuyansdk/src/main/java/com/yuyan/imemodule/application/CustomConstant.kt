...
object CustomConstant {
    ...
    const val CURRENT_RIME_DICT_DATA_VERSIOM = 20251007
    const val YUYAN_IME_REPO = "https://github.com/iYuhuo/YuyanIme"
    const val LICENSE_URL = "https://www.gnu.org/licenses/gpl-3.0.html"
    const val FEEDBACK_TXC_REPO = "https://github.com/iYuhuo/YuyanIme/issues"
